...
function graffiti_pen:onTouchEvent(sys, event)
    ...
    -- Amaz.LOGD(self.logTag, "onTouchEvent() selectedEntityIndex:".. tostring(selectedEntityIndex))   
    ...
    -- Amaz.LOGS(self.logTag, "graffiti: onTouchEvent() point: ".. tostring(point.x).. " ".. tostring(point.y))
...
function graffiti_pen:onEvent(sys, event)
    ...
    local inputKey = event.args:get(0)
    -- Amaz.LOGD(self.logTag, "onEvent() inputKey:".. (inputKey))
