...
void main() {
    ...
    sample_weight = 0.12 * neighborColor.a;
    sum_weight += sample_weight; 
    sum += neighborColor * sample_weight; 
    ...
    sample_weight = 0.09 * neighborColor.a;
    sum_weight += sample_weight;
    sum += neighborColor * sample_weight;
    ...
    neighborColor = texture2D(u_inputTex, textureShift_3.xy); 
    sample_weight = 0.05 * neighborColor.a;
    sum_weight += sample_weight;  
    sum += neighborColor * sample_weight; 
