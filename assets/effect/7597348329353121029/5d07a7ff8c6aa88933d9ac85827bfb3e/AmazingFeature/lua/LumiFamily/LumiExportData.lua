...
local ae_transitionInputIndex = {
    {'LumiLayer_68-blend', 'InputTex', 0},
    {'LumiLayer_68-blend', 'baseTex', 1},
}
data.ae_transitionInputIndex = ae_transitionInputIndex

local ae_durations = {
    ['LumiAnimSeqLoadAndCrop_1169-effect0'] = {
        ['nodeDuration'] = {{0, 3}, },
        ['texDuration'] = {
            ['InputTex'] = {{0, 3}, },
            ['seqTex_1_1'] = {{0, 2}, },
...
local ae_keyframes = {
    ['LumiAnimSeqLoadAndCrop_1169-effect0#seqTime#number'] =
{
	{
