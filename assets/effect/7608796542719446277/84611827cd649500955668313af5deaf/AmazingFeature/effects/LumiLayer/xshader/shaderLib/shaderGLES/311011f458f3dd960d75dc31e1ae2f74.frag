...
vec4 _f6(inout vec4 _p0, inout vec4 _p1)
{
    ...
    if (u_layerType == 1)
    {
        ...
        vec4 _635 = mix(_p1, vec4(_t33.xyz, _p0.w), vec4(u_layerOpacity * _t35));
        _t34 = _635;
        float _637 = _t34.w;
        vec3 _640 = _635.xyz * _637;
        _t34.x = _640.x;
        _t34.y = _640.y;
        _t34.z = _640.z;
    }
    ...
    {
        vec3 _675 = (((_p1.xyz * _p1.w) * (1.0 - _p0.w)) + ((_p0.xyz * _p0.w) * (1.0 - _p1.w))) + (_t33.xyz * (_p0.w * _p1.w));
        _t34.x = _675.x;
        _t34.y = _675.y;
        _t34.z = _675.z;
...
void main()
{
    ...
    if (u_hasTrs == 1)
    {
        ...
        mat4 param_1 = u_pMat;
        vec2 param_2 = uv0;
        vec2 _736 = _f2(param, param_1, param_2);
        float _739 = step(u_mirrorEdge, 0.5);
        vec2 param_3 = _736;
        vec2 _749 = (_736 * _739) + (_f4(param_3) * (1.0 - _739));
        vec2 param_4 = _749;
        _t37 = (texture2D(u_sourceTexture, _749) * u_alpha) * _f3(param_4);
    }
    else
    {
