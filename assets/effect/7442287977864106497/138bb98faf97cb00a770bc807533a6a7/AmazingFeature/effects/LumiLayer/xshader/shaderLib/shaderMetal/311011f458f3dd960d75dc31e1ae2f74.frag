...
static inline __attribute__((always_inline))
float4 _f39(thread float4& _p0, thread float4& _p1, constant int& u_enableMatte, texture2d<float> u_maskTexture, sampler u_maskTextureSmplr, thread float2& uv0, constant int& u_matteMode, constant float& u_yuCheng, constant int& u_blendMode, constant int& u_layerType, constant int& u_hasMatte, constant float& u_layerOpacity)
{
    if (u_yuCheng < 0.5)
    {
        float _1398 = _p0.w;
        float4 _1400 = _p0;
        float3 _1403 = _1400.xyz / float3(fast::max(_1398, 9.9999997473787516355514526367188e-06));
        _p0.x = _1403.x;
        _p0.y = _1403.y;
        _p0.z = _1403.z;
        float _1411 = _p1.w;
        float4 _1413 = _p1;
        float3 _1416 = _1413.xyz / float3(fast::max(_1411, 9.9999997473787516355514526367188e-06));
        _p1.x = _1416.x;
        _p1.y = _1416.y;
        _p1.z = _1416.z;
    }
    ...
    else
    {
        ...
        else
        {
            if (u_blendMode == 3)
            {
                float3 _1467 = abs(_p0.xyz - _p1.xyz);
                _t32.x = _1467.x;
                _t32.y = _1467.y;
                _t32.z = _1467.z;
            }
            else
            {
                if (u_blendMode == 4)
                {
                    ...
                    float3 _1549 = float3(_1483, _1506, _1529);
                    _t32.x = _1549.x;
                    _t32.y = _1549.y;
                    _t32.z = _1549.z;
                }
                else
                {
                    if (u_blendMode == 5)
                    {
                        float3 _1566 = fast::min(_p0.xyz, _p1.xyz);
                        _t32.x = _1566.x;
                        _t32.y = _1566.y;
                        _t32.z = _1566.z;
                    }
                    else
                    {
                        if (u_blendMode == 6)
                        {
                            float3 _1583 = fast::max(_p0.xyz, _p1.xyz);
                            _t32.x = _1583.x;
                            _t32.y = _1583.y;
                            _t32.z = _1583.z;
                        }
                        else
                        {
                            if (u_blendMode == 7)
                            {
                                ...
                                float3 _1602 = _f2(param, param_1);
                                _t32.x = _1602.x;
                                _t32.y = _1602.y;
                                _t32.z = _1602.z;
                            }
                            else
                            {
                                if (u_blendMode == 8)
                                {
                                    ...
                                    float3 _1621 = _f4(param_2, param_3);
                                    _t32.x = _1621.x;
                                    _t32.y = _1621.y;
                                    _t32.z = _1621.z;
                                }
                                else
                                {
                                    if (u_blendMode == 9)
                                    {
                                        ...
                                        float3 _1640 = _f15(param_4, param_5);
                                        _t32.x = _1640.x;
                                        _t32.y = _1640.y;
                                        _t32.z = _1640.z;
                                    }
                                    else
                                    {
                                        if (u_blendMode == 10)
                                        {
                                            ...
                                            float3 _1659 = _f16(param_6, param_7);
                                            _t32.x = _1659.x;
                                            _t32.y = _1659.y;
                                            _t32.z = _1659.z;
                                        }
                                        else
                                        {
                                            if (u_blendMode == 11)
                                            {
                                                ...
                                                float3 _1678 = _f17(param_8, param_9);
                                                _t32.x = _1678.x;
                                                _t32.y = _1678.y;
                                                _t32.z = _1678.z;
                                            }
                                            else
                                            {
                                                if (u_blendMode == 12)
                                                {
                                                    float3 _1701 = (_p0.xyz + _p1.xyz) - (_p0.xyz * _p1.xyz);
                                                    _t32.x = _1701.x;
                                                    _t32.y = _1701.y;
                                                    _t32.z = _1701.z;
                                                }
                                                else
                                                {
                                                    if (u_blendMode == 13)
                                                    {
                                                        ...
                                                        float3 _1720 = _f22(param_10, param_11);
                                                        _t32.x = _1720.x;
                                                        _t32.y = _1720.y;
                                                        _t32.z = _1720.z;
                                                    }
                                                    else
                                                    {
                                                        if (u_blendMode == 14)
                                                        {
                                                            ...
                                                            float3 _1739 = _f24(param_12, param_13);
                                                            _t32.x = _1739.x;
                                                            _t32.y = _1739.y;
                                                            _t32.z = _1739.z;
                                                        }
                                                        else
                                                        {
                                                            if (u_blendMode == 15)
                                                            {
                                                                ...
                                                                float3 _1758 = _f26(param_14, param_15);
                                                                _t32.x = _1758.x;
                                                                _t32.y = _1758.y;
                                                                _t32.z = _1758.z;
                                                            }
                                                            else
                                                            {
                                                                if (u_blendMode == 16)
                                                                {
                                                                    ...
                                                                    float3 _1777 = _f28(param_16, param_17);
                                                                    _t32.x = _1777.x;
                                                                    _t32.y = _1777.y;
                                                                    _t32.z = _1777.z;
                                                                }
                                                                else
                                                                {
                                                                    if (u_blendMode == 17)
                                                                    {
                                                                        ...
                                                                        float3 _1796 = _f30(param_18, param_19);
                                                                        _t32.x = _1796.x;
                                                                        _t32.y = _1796.y;
                                                                        _t32.z = _1796.z;
                                                                    }
                                                                    else
                                                                    {
                                                                        if (u_blendMode == 18)
                                                                        {
                                                                            ...
                                                                            float3 _1815 = _f32(param_20, param_21);
                                                                            _t32.x = _1815.x;
                                                                            _t32.y = _1815.y;
                                                                            _t32.z = _1815.z;
                                                                        }
                                                                        else
                                                                        {
                                                                            if (u_blendMode == 19)
                                                                            {
                                                                                ...
                                                                                float3 _1834 = _f34(param_22, param_23);
                                                                                _t32.x = _1834.x;
                                                                                _t32.y = _1834.y;
                                                                                _t32.z = _1834.z;
                                                                            }
                                                                            else
                                                                            {
                                                                                if (u_blendMode == 20)
                                                                                {
                                                                                    ...
                                                                                    float3 _1853 = _f36(param_24, param_25);
                                                                                    _t32.x = _1853.x;
                                                                                    _t32.y = _1853.y;
                                                                                    _t32.z = _1853.z;
                                                                                }
                                                                                else
                                                                                {
                                                                                    if (u_blendMode == 21)
                                                                                    {
                                                                                        float3 _1877 = (_p1.xyz + _p0.xyz) - ((_p1.xyz * 2.0) * _p0.xyz);
                                                                                        _t32.x = _1877.x;
                                                                                        _t32.y = _1877.y;
                                                                                        _t32.z = _1877.z;
                                                                                    }
                                                                                    else
                                                                                    {
                                                                                        if (u_blendMode == 22)
                                                                                        {
                                                                                            float3 _1895 = fast::max(float3(0.0), _p1.xyz - _p0.xyz);
                                                                                            _t32.x = _1895.x;
                                                                                            _t32.y = _1895.y;
                                                                                            _t32.z = _1895.z;
                                                                                        }
                                                                                        else
                                                                                        {
                                                                                            if (u_blendMode == 23)
                                                                                            {
                                                                                                ...
                                                                                                float3 _1914 = _f38(param_26, param_27);
                                                                                                _t32.x = _1914.x;
                                                                                                _t32.y = _1914.y;
                                                                                                _t32.z = _1914.z;
                                                                                            }
                                                                                            else
                                                                                            {
                                                                                                if (u_blendMode == 24)
                                                                                                {
                                                                                                    ...
                                                                                                    float3 _1933 = _f20(param_28, param_29);
                                                                                                    _t32.x = _1933.x;
                                                                                                    _t32.y = _1933.y;
                                                                                                    _t32.z = _1933.z;
                                                                                                }
                                                                                                else
                                                                                                {
                                                                                                    if (u_blendMode == 25)
                                                                                                    {
                                                                                                        ...
                                                                                                        float3 _1952 = _f19(param_30, param_31);
                                                                                                        _t32.x = _1952.x;
                                                                                                        _t32.y = _1952.y;
                                                                                                        _t32.z = _1952.z;
                                                                                                    }
                                                                                                    else
                                                                                                    {
                                                                                                        if (u_blendMode == 26)
                                                                                                        {
                                                                                                            ...
                                                                                                            float3 _1971 = _f18(param_32, param_33);
                                                                                                            _t32.x = _1971.x;
                                                                                                            _t32.y = _1971.y;
                                                                                                            _t32.z = _1971.z;
                                                                                                        }
    ...
    if (u_layerType == 1)
    {
        ...
        float4 _2052 = mix(_p1, float4(_t32.xyz, _p0.w), float4(u_layerOpacity * _t34));
        _t33 = _2052;
        float _2054 = _t33.w;
        float3 _2057 = _2052.xyz * _2054;
        _t33.x = _2057.x;
        _t33.y = _2057.y;
        _t33.z = _2057.z;
    }
    ...
    {
        float3 _2092 = (((_p1.xyz * _p1.w) * (1.0 - _p0.w)) + ((_p0.xyz * _p0.w) * (1.0 - _p1.w))) + (_t32.xyz * (_p0.w * _p1.w));
        _t33.x = _2092.x;
        _t33.y = _2092.y;
        _t33.z = _2092.z;
...
fragment main0_out main0(main0_in in [[stage_in]], constant buffer_t& buffer, texture2d<float> u_maskTexture [[texture(0)]], texture2d<float> u_baseTexure [[texture(1)]], texture2d<float> u_sourceTexture [[texture(2)]], sampler u_maskTextureSmplr [[sampler(0)]], sampler u_baseTexureSmplr [[sampler(1)]], sampler u_sourceTextureSmplr [[sampler(2)]])
{
    ...
    bool _2115 = buffer.u_hasBlend == 1;
    if (_2115)
    {
    ...
    if (buffer.u_hasTrs == 1)
    {
        ...
        float2 _2153 = _f8(param, param_1, param_2);
        float _2156 = step(buffer.u_mirrorEdge, 0.5);
        float2 param_3 = _2153;
        float2 _2166 = (_2153 * _2156) + (_f10(param_3) * (1.0 - _2156));
        float2 param_4 = _2166;
        _t36 = (u_sourceTexture.sample(u_sourceTextureSmplr, _2166) * buffer.u_alpha) * _f9(param_4);
    }
    else
    {
    ...
    if (_2115)
    {
        if (buffer.u_opacityMix > 0.5)
        {
            float4 param_6 = _t36;
            float4 param_7 = _t35;
            float4 _2209 = _f39(param_6, param_7, buffer.u_enableMatte, u_maskTexture, u_maskTextureSmplr, in.uv0, buffer.u_matteMode, buffer.u_yuCheng, buffer.u_blendMode, buffer.u_layerType, buffer.u_hasMatte, buffer.u_layerOpacity);
            _t36 = _2209;
        }
        else
        {
            float4 param_8 = _t36 * _t35.w;
            float4 param_9 = _t35;
            float4 _2218 = _f39(param_8, param_9, buffer.u_enableMatte, u_maskTexture, u_maskTextureSmplr, in.uv0, buffer.u_matteMode, buffer.u_yuCheng, buffer.u_blendMode, buffer.u_layerType, buffer.u_hasMatte, buffer.u_layerOpacity);
            _t36 = _2218;
        }
    }
