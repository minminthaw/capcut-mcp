...
void main()
{
    ...
    gl_Position = u_MVP * vec4(((vec2(_t31.x + 0.21400000154972076416015625, _t41.y + 0.21400000154972076416015625) * 1.39999997615814208984375) - vec2(1.0)) * vec2(u_ScreenParams.x / u_ScreenParams.y, 1.0), 0.0, 1.0);
    v_uv = a_texcoord0;
}
