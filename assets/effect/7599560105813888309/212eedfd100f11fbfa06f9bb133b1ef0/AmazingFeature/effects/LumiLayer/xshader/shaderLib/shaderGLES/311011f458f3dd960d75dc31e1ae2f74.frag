...
vec4 _f6(inout vec4 _p0, inout vec4 _p1)
{
    ...
    if (u_blendMode == 12)
    {
        vec3 _528 = (_p0.xyz + _p1.xyz) - (_p0.xyz * _p1.xyz);
        _t33.x = _528.x;
        _t33.y = _528.y;
        _t33.z = _528.z;
    }
    ...
    if (u_layerType == 1)
    {
        ...
        vec4 _575 = mix(_p1, vec4(_t33.xyz, _p0.w), vec4(u_layerOpacity * _t35));
        _t34 = _575;
        float _577 = _t34.w;
        vec3 _580 = _575.xyz * _577;
        _t34.x = _580.x;
        _t34.y = _580.y;
        _t34.z = _580.z;
    }
    ...
    {
        vec3 _615 = (((_p1.xyz * _p1.w) * (1.0 - _p0.w)) + ((_p0.xyz * _p0.w) * (1.0 - _p1.w))) + (_t33.xyz * (_p0.w * _p1.w));
        _t34.x = _615.x;
        _t34.y = _615.y;
        _t34.z = _615.z;
...
void main()
{
    ...
    if (u_hasTrs == 1)
    {
        ...
        mat4 param_1 = u_pMat;
        vec2 param_2 = uv0;
        vec2 _676 = _f2(param, param_1, param_2);
        float _680 = step(u_mirrorEdge, 0.5);
        vec2 param_3 = _676;
        vec2 _690 = (_676 * _680) + (_f4(param_3) * (1.0 - _680));
        vec2 param_4 = _690;
        _t37 = (texture2D(u_sourceTexture, _690) * u_alpha) * _f3(param_4);
    }
    else
    {
