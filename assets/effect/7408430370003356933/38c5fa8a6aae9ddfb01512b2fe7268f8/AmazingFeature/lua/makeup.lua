...
function makeup:updateFaceInfoBySize()
    ...
    local facefittingCount = result:getAlgorithmInfoCount('new-model-3d-5b76cf08-5927-11ed-b0cf-3e22fb85aea1', 'facefitting_3d_0', 'facefitting_3d')
    ...
    for i = 0, self.maxFaceNum - 1 do
        ...
        if i < faceCount then
            ...
            for j = 0, facefittingCount - 1 do
                local faceMeshInfo = result:getAlgorithmInfo('new-model-3d-5b76cf08-5927-11ed-b0cf-3e22fb85aea1', 'facefitting_3d_0', 'facefitting_3d', j) 
