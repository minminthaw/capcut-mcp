...
local ae_transitionInputIndex = {
    {'LumiLayer_1692-blend', 'baseTex', 0},
    {'LumiLayer_1695-matte-blend', 'InputTex', 1},
    {'LumiLayer_1697-trs-blend', 'InputTex', 1},
}
data.ae_transitionInputIndex = ae_transitionInputIndex

local ae_durations = {
    ['LumiAnimSeqLoadAndCrop_1694-effect0'] = {
        ['nodeDuration'] = {{-0.03333333333333, 1.96666666666667}, },
        ['texDuration'] = {
            ['InputTex'] = {{-0.03333333333333, 1.96666666666667}, },
            ['seqTex_1_1'] = {{0, 3}, },
            ['seqTex_9_16'] = {{0, 3}, },
            ['seqTex_16_9'] = {{0, 3}, },
        },
    },
    ['LumiAnimSeqLoadAndCrop_1692-effect0'] = {
        ['nodeDuration'] = {{0, 2}, },
        ['texDuration'] = {
            ['InputTex'] = {{0, 2}, },
            ['seqTex_1_1'] = {{0, 3}, },
    ...
    ['LumiLayer_1695-matte-blend'] = {
        ['nodeDuration'] = {{0, 2}, },
        ['texDuration'] = {
            ['InputTex'] = {{0, 2}, },
            ['baseTex'] = {{0, 2}, },
            ['maskTex'] = {{-0.03333333333333, 1.96666666666667}, },
        },
    },
    ['LumiLayer_1697-trs-blend'] = {
        ['nodeDuration'] = {{0, 2}, },
        ['texDuration'] = {
            ['InputTex'] = {{0, 2}, },
            ['baseTex'] = {{0, 2}, },
...
local ae_keyframes = {
    ['LumiAnimSeqLoadAndCrop_1694-effect0#seqTime#number'] =
{
	{
		{0.166666667, 0.166666667, 0.833333333, 0.833333333, }, 
		{-0.03333333333333, 1.96666666666667, }, 
		{{0, }, {2, }, }, 
		{6417, }, 
		{1, }, 
	}, 
},
    ['LumiAnimSeqLoadAndCrop_1692-effect0#seqTime#number'] =
{
	{
		{0.166666667, 0.166666667, 0.833333333, 0.833333333, }, 
		{0, 2, }, 
    ...
    ['LumiLayer_1697-trs-blend#opacity#number'] =
{
	{
		{0.166666667, 0.166666667, 0.833333333, 0.833333333, }, 
		{1.633333, 1.666667, }, 
