...
void main()
{
    ...
    vec2 param = uv0;
    vec4 _159 = _f1(u_inputTexture, param);
    vec4 _t3 = _159;
    float _t4 = 1.0;
    float _t5 = 1.0;
    vec4 _t6 = _159 * 1.0;
    ...
    for (mediump int _t14 = 1; _t14 <= 128; _t14++)
    {
        ...
        if (_285)
        {
            ...
            else
            {
                ...
                _t16.y = _306;
                vec2 param_11 = _t16;
                _t6 += (_f1(u_inputTexture, param_11) * _t4);
                _t5 += _t4;
            }
        }
        else
        {
            vec2 param_12 = _t16;
            _t6 += (_f1(u_inputTexture, param_12) * _t4);
            _t5 += _t4;
        }
        if (_147)
        {
            ...
            if (_361)
            {
                ...
                else
                {
                    ...
                    _t16.y = _380;
                    vec2 param_15 = _t16;
                    _t6 += (_f1(u_inputTexture, param_15) * _t4);
                    _t5 += _t4;
                }
            }
            else
            {
                vec2 param_16 = _t16;
                _t6 += (_f1(u_inputTexture, param_16) * _t4);
                _t5 += _t4;
            }
        }
    }
