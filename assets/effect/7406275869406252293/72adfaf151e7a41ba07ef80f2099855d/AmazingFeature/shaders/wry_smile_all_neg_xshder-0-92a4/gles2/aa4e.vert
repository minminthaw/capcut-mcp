...
void main()
{
    ...
    // map the intensity [0.1 0.5] to [0 0.8], [0 0.1] to [0.8 1.1]
    float final_intensity = 2.0 * (0.5 - uIntensity) * step(uIntensity, 0.5);
    float gradual = 1.0 + 0.5 * (final_intensity - 0.8) * step(0.8, final_intensity);
