...
local ae_compDurations = {0, 1.98333333333333}
...
local ae_transitionInputIndex = {
    {'LumiLayer_27-blend', 'InputTex', 0},
    {'LumiLayer_27-blend', 'baseTex', 1},
}
...
local ae_durations = {
    ...
    ['LumiLayer_48-trs-blend'] = {
        ['nodeDuration'] = {{0, 2}, },
        ['texDuration'] = {
            ['InputTex'] = {{0.66666666666667, 1.33333333333333}, },
            ['baseTex'] = {{0, 2}, },
        },
    },
    ['LumiAnimSeqLoadAndCrop_30-effect0'] = {
        ['nodeDuration'] = {{0, 2}, },
        ['texDuration'] = {
            ['InputTex'] = {{0, 2}, },
            ['seqTex_1_1'] = {{0, 2}, },
...
local ae_keyframes = {
    ['LumiLayer_48-trs-blend#opacity#number'] =
{
	{
    ...
    ['LumiAnimSeqLoadAndCrop_30-effect0#seqTime#number'] =
{
	{
		{0.166666667, 0.166666667, 0.833333333, 0.833333333, }, 
		{0, 2, }, 
