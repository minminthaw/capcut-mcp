...
void main(void)
{
    ...
    vec4 screen_sucai = texture2D(blendmodeScreenTexture, sucaiTexCoord) * clamp(intensity * opacity, 0.0, 1.0);
    float nonZeroScreenSucaiAlpha = step(0.0, -screen_sucai.a) * 0.000001 + screen_sucai.a;
