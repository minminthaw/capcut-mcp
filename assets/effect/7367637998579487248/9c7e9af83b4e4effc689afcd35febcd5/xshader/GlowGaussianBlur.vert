...
attribute vec4 a_bloomPara;  // bloomLightStrength, bloomRange, bloomDirX, bloomDirY
attribute vec4 a_bloomPara2;  // bloomColorCustomized, 0, 0, 0
...
{ 
    ...
    gl_Position = sign(vec4(a_texcoord0*2.0-1.0, 0.0, 1.0));
    uv0 = a_texcoord0;

    vec2 position = a_position;
    vec2 a_Texcoord = a_texcoord0;
