...
vec4 _f6(inout vec4 _p0, inout vec4 _p1)
{
    ...
    if (u_layerType == 1)
    {
        ...
        vec4 _568 = mix(_p1, vec4(_t33.xyz, _p0.w), vec4(u_layerOpacity * _t35));
        _t34 = _568;
        float _570 = _t34.w;
        vec3 _573 = _568.xyz * _570;
        _t34.x = _573.x;
        _t34.y = _573.y;
        _t34.z = _573.z;
    }
    ...
    {
        vec3 _608 = (((_p1.xyz * _p1.w) * (1.0 - _p0.w)) + ((_p0.xyz * _p0.w) * (1.0 - _p1.w))) + (_t33.xyz * (_p0.w * _p1.w));
        _t34.x = _608.x;
        _t34.y = _608.y;
        _t34.z = _608.z;
...
void main()
{
    ...
    if (u_hasTrs == 1)
    {
        ...
        mat4 param_1 = u_pMat;
        vec2 param_2 = uv0;
        vec2 _669 = _f2(param, param_1, param_2);
        float _673 = step(u_mirrorEdge, 0.5);
        vec2 param_3 = _669;
        vec2 _683 = (_669 * _673) + (_f4(param_3) * (1.0 - _673));
        vec2 param_4 = _683;
        _t37 = (texture2D(u_sourceTexture, _683) * u_alpha) * _f3(param_4);
    }
    else
    {
