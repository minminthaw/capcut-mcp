...
local ae_durations = {
    ['LumiAnimSeqLoadAndCrop_32-effect0'] = {
        ['nodeDuration'] = {{0, 3}, },
        ['texDuration'] = {
            ['InputTex'] = {{0, 3}, },
            ['seqTex_1_1'] = {{0, 3}, },
...
local ae_keyframes = {
    ['LumiAnimSeqLoadAndCrop_32-effect0#seqTime#number'] =
{
	{
...
local ae_sliderInfos = {
    ['effects_adjust_background_animation'] = {
        {'LumiAnimSeqLoadAndCrop_32-effect0', 'globalOpacity', 'number', {true, }, 1, 2, 0, 1, {0, }, {0, }, },
    },
}
