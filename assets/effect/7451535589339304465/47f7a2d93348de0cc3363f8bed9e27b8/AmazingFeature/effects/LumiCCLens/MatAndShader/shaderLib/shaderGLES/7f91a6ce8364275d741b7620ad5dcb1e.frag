...
void main()
{
    ...
    mediump float param_1 = _142;
    mediump float param_2 = u_Convergence;
    ...
    gl_FragData[0] = ((texture2D(u_InputTex, _t10) * _t13.x) * _t13.y) * smoothstep(_176 + 0.001000000047497451305389404296875, _176 - 0.001000000047497451305389404296875, _t12.z);
}
