...
local ae_transitionInputIndex = {
    {'LumiLayer_2755-blend', 'baseTex', 0},
}
data.ae_transitionInputIndex = ae_transitionInputIndex

local ae_durations = {
    ['LumiAnimSeqLoadAndCrop_2755-effect0'] = {
        ['nodeDuration'] = {{0, 3.16666666666667}, },
        ['texDuration'] = {
            ['InputTex'] = {{0, 3.16666666666667}, },
            ['seqTex_1_1'] = {{0, 3.03333333333333}, },
        },
    },
    ['LumiLayer_2755-blend'] = {
        ['nodeDuration'] = {{0, 3.16666666666667}, },
        ['texDuration'] = {
            ['InputTex'] = {{0, 3.16666666666667}, },
...
local ae_keyframes = {
    ['LumiAnimSeqLoadAndCrop_2755-effect0#seqTime#number'] =
{
	{
