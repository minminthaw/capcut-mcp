...
vertex main0_out main0(main0_in in [[stage_in]], constant buffer_t& buffer)
{
    ...
    if (buffer.uIntensity < 0.5)
    {
        final_intensity = 0.5 - buffer.uIntensity;
        if (buffer.uIntensity > 0.100000001490116119384765625)
        {
            final_intensity *= 2.0;
        }
        else
        {
            float gradual = 2.0 + (15.0 * (0.100000001490116119384765625 - buffer.uIntensity));
