...
uniform mediump int u_blurType;
...
void main()
{
    ...
    vec2 param = uv0;
    vec4 _203 = _f1(u_inputTexture, param);
    vec4 _t5 = _203;
    float _t6 = 1.0;
    float _t7 = 1.0;
    vec4 _t8 = _203 * 1.0;
    ...
    for (mediump int _t17 = 1; _t17 <= 128; _t17++)
    {
        ...
        if (_342)
        {
            ...
            else
            {
                ...
                _t19.y = _363;
                vec2 param_15 = _t19;
                _t8 += (_f1(u_inputTexture, param_15) * _t6);
                _t7 += _t6;
            }
        }
        else
        {
            vec2 param_16 = _t19;
            _t8 += (_f1(u_inputTexture, param_16) * _t6);
            _t7 += _t6;
        }
        if (_191)
        {
            ...
            if (_427)
            {
                ...
                else
                {
                    ...
                    _t19.y = _446;
                    vec2 param_23 = _t19;
                    _t8 += (_f1(u_inputTexture, param_23) * _t6);
                    _t7 += _t6;
                }
            }
            else
            {
                vec2 param_24 = _t19;
                _t8 += (_f1(u_inputTexture, param_24) * _t6);
                _t7 += _t6;
            }
        }
    }
