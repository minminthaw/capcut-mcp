...
local ae_transitionInputIndex = {
    {'LumiLayer_40-blend', 'InputTex', 1},
    {'LumiLayer_40-blend', 'baseTex', 0},
}
...
local ae_durations = {
    ['LumiLayer_40-blend'] = {
        ...
        ['texDuration'] = {
            ['InputTex'] = {{1, 2}, },
            ['baseTex'] = {{0, 1.01666666666667}, },
        },
    },
    ['LumiAnimSeqLoadAndCrop_49-effect0'] = {
        ['nodeDuration'] = {{0, 2}, },
        ['texDuration'] = {
            ['InputTex'] = {{0, 2}, },
            ['seqTex_1_1'] = {{0, 2}, },
...
local ae_keyframes = {
    ['LumiAnimSeqLoadAndCrop_49-effect0#seqTime#number'] =
{
	{
