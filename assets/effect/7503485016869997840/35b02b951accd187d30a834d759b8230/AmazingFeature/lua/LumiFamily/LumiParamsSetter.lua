...
function LumiParamsSetter:updateSlider(lumi_obj, startTime, endTime, curTime, aeTime)
    ...
    lumi_obj:setSubEffectAttr("LumiColorAdjustBundle_25-effect0", "whiteIntensity", remap2(value, 0, 0.15))
    ...
    lumi_obj:setSubEffectAttr("LumiColorAdjustBundle_25-effect2", "highlightIntensity", remap2(value, 0, 0.15))
    ...
    lumi_obj:setSubEffectAttr("LumiColorAdjustBundle_25-effect3", "dahazeIntensity", remap2(value, 0, 0.2))
