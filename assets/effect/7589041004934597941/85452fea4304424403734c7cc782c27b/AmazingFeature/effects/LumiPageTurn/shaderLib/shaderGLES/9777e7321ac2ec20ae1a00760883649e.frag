...
void _f6(vec2 _p0, vec2 _p1, vec2 _p2, float _p3, float _p4, inout vec4 _p5)
{
    ...
    _t37 = mix(_568 * _506, _568 * _574, vec4(_574));
    vec3 _t39 = _389;
    if (_t27 > 0.5)
    {
        vec3 param_18 = _t25;
    ...
    vec2 param_20 = _p0;
    vec3 param_21 = _t39;
    vec2 _601 = _f3(param_20, param_21);
    vec2 param_22 = _601;
    vec2 param_23 = _542;
    vec3 param_24 = _t39;
    vec2 _613 = _f3(param_23, param_24);
    vec2 param_25 = _613;
    float _626 = (_f0(param_25) * (1.0 - _506)) * _521;
    mediump vec4 _637 = texture2D(u_frontTex, mix(_601, _613, vec2(_626)));
    vec4 _643 = _637 * clamp(_626 + (_506 * _f0(param_22)), 0.0, 1.0);
    if (u_renderFace == 0)
    {
        _p5 = mix(_643, _p5, vec4(_p5.w));
