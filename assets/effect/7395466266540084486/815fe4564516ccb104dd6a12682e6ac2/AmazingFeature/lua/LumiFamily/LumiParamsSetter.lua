    ...
    for sliderKey, paramsInfos in pairs(self.sliderInfos) do
        if self.sliderParams[sliderKey] ~= nil then
            for index, value in ipairs(paramsInfos) do
                ...
                if caluType == 0 then
                    newValue = add(mul(add(oriValue, -sliderIntensity), valueA), valueB)
                elseif caluType == 1 then
                    newValue = add(mul(add(oriValue, -valueA), sliderIntensity), valueB)
                elseif caluType == 2 then
                    newValue = add(mul(add(oriValue, -valueA), valueB), sliderIntensity)
                end
