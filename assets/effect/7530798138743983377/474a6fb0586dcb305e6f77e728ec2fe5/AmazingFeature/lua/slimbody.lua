...
-- input
local BODY_ID = "id"
local BODY_ADJUST_INTENSITY = "comic_intensity"
...
local SlimBodyMap = {
    SlimBreast = {
        ...
        min_ratio = 0.0,
        --- ori 1.1, beauty breast 1.1 * 0.7 (11.22)
        max_ratio = 0.5
    },
    SlimHip = {
        -- 美胯
        ...
        min_ratio = 0.0,
        --- ori 1.4, beauty hip 1.4 * 0.6 (12.10)
        max_ratio = 0.84
    },
    SwanNeck = {
        -- 天鹅颈
        ...
        min_ratio = 0.0,
        --- ori 0.55, swan neck 0.55 * 0.7 （12.10）
        max_ratio = 0.385
    },
    SlimArm = {
        -- 瘦手臂
        ...
        min_ratio = 0.0,
        --- ori 1.0, slim arm 1.0 * 0.4 (11.22)
        max_ratio = 0.4
    },
    WidenShoulder = {
        -- 宽肩
        ...
        min_ratio = 0.0,
        --- ori 2.0, widen shoulder 2.0 * 0.15 (12.10)
        max_ratio = 0.3
    },
    SlimBody = {
        -- 瘦身
        ...
        min_ratio = 0.0,
        --- ori 0.6, slim body 0.6 * 0.35 (12.10)
        max_ratio = 0.21
    },
    SlimWaist = {
        -- 瘦腰
        ...
        min_ratio = 0.0,
        --- ori 0.5, slim waist 0.5 * 0.55 (11.22)
        max_ratio = 0.4
    },
    LongLeg = {
        -- 长腿
        ...
        min_ratio = 0.0,
        --- ori 0.35, slim leg 0.35 * 0.15 (11.22)
        max_ratio = 0.0525
    },
    SmallHead = {
        -- 小头
        ...
        min_ratio = 0.0,
        --- ori 0.2, slim head 0.2 * 0.7 (12.10)
        max_ratio = 0.14
    },
    SlimLeg = {
        -- 瘦腿
        ...
        min_ratio = 0.0,
        --- ori 1.0, slim leg 1.0 * 0.15 (11.22)
        max_ratio = 0.15
    },
}
...
function slimbody:updateItems(comp, deltaTime)
    ...
    -- Amaz.LOGE(self.logTag, "[zhw debug][dsFaceu] updateItems enter")
    local items = self.slimbodyComp.items
    local itemsCount = items:size()
    for key, info in pairs(SlimBodyMap) do
        ...
        for i = 0, itemsCount - 1 do
            ...
            if item.type == itemType then
                ...
                -- Amaz.LOGE(self.logTag, "[ant-check][dsFaceu] updateItem: key " .. key .. " itemType:".. itemType .. " intensity:" .. itemIntensity .. " item.intensity:" .. item.intensity)
                items:set(i, item)
            end
        end
    end
