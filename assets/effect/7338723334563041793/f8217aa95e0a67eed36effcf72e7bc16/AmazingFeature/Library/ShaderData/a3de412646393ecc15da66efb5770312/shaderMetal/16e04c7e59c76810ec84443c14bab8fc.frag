...
fragment main0_out main0(main0_in in [[stage_in]], constant buffer_t& buffer, texture2d<float> inputTexture [[texture(0)]], sampler inputTextureSmplr [[sampler(0)]])
{
    ...
    float4 _678 = _747;
    _678.x = fma(_334.y, 0.0039215688593685626983642578125, _334.x);
    float4 _680 = _678;
    _680.y = fma(_334.w, 0.0039215688593685626983642578125, _334.z);
    ...
    for (float _709 = 1.0, _710 = 1.0; _709 <= 1024.0; _725 = _486, _721 = _482, _710 = _489, _709 += 1.0)
    {
        ...
        float4 _737 = float4(step(_710, buffer.ColorRadius.x) * exp(_503 / buffer.ColorSigma.x), step(_710, buffer.ColorRadius.y) * exp(_503 / buffer.ColorSigma.y), _743, _743);
        ...
        _482 = fma((float4(fma(_567.y, 0.0039215688593685626983642578125, _567.x), fma(_567.w, 0.0039215688593685626983642578125, _567.z), 0.0, 0.0) * _716.x) + (float4(fma(_577.y, 0.0039215688593685626983642578125, _577.x), fma(_577.w, 0.0039215688593685626983642578125, _577.z), 0.0, 0.0) * _716.y), _737, _721);
        _486 = _725 + (_737 * 2.0);
        _489 = _710 + _397;
    }
    float4 _496 = _721 / _725;
    float _652 = _496.x * 255.0;
    float _661 = _496.y * 255.0;
